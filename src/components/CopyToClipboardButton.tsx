...
const CopyToClipboardButton = ({
    ...
    const getVariantClasses = () => {
        switch (variant) {
            case 'ghost':
                return 'bg-transparent hover:bg-gray-100 text-gray-600 hover:text-gray-800'
            case 'outline':
                return 'bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 hover:text-gray-900'
            default:
